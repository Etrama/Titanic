...
This is a ML trial on titanic script file.
"""
...
#using pandas to convert the excel data files into dataframes
train_df = pd.read_csv('C:/ML/Titanic/train.csv')
test_df = pd.read_csv('C:/ML/Titanic/test.csv')
...
print "perceptron accuracy is: ", acc_perceptron
print('_'*40)
...
print "linear svc accuracy is: ", acc_linear_svc
print('_'*40)
...
print "accuracy of decision tree is: ", acc_decision_tree
print('_'*40)
...
print "accuracy of randomf forest :", acc_random_forest
